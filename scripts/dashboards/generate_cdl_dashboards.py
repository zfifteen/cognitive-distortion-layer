...
def create_kappa_histograms():
    ...
    plt.savefig(FIGURES_DIR / 'cdl_kappa_histograms.png', dpi=300, bbox_inches='tight')
...
def create_z_normalized_traces():
    ...
    plt.tight_layout()
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
    plt.savefig(FIGURES_DIR / 'cdl_z_normalized_traces.png', dpi=300, bbox_inches='tight')
...
def create_classification_boundary():
    ...
    plt.tight_layout()
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
    plt.savefig(FIGURES_DIR / 'cdl_classification_boundary.png', dpi=300, bbox_inches='tight')
...
def create_scale_comparison():
    ...
    plt.tight_layout()
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
    plt.savefig(FIGURES_DIR / 'cdl_scale_comparison.png', dpi=300, bbox_inches='tight')
...
def create_integration_examples():
    ...
    plt.tight_layout()
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
    plt.savefig(FIGURES_DIR / 'cdl_integration_examples.png', dpi=300, bbox_inches='tight')

...
SIMULATED_DATA_DIR = ROOT / "data" / "simulated"
...
def create_curvature_comparison_plot():
    ...
    data = load_experimental_data(SIMULATED_DATA_DIR / 'results_load_0.csv')
    ...
    plt.savefig(FIGURES_DIR / 'curvature_analysis.png', dpi=300, bbox_inches='tight')
    plt.close()

def create_load_effect_plot():
    """Create a plot showing the effect of cognitive load."""
    load_0 = load_experimental_data(SIMULATED_DATA_DIR / 'results_load_0.csv')
    load_30 = load_experimental_data(SIMULATED_DATA_DIR / 'results_load_30.csv')
    load_70 = load_experimental_data(SIMULATED_DATA_DIR / 'results_load_70.csv')
    ...
    plt.tight_layout()
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
    plt.savefig(FIGURES_DIR / 'load_effects.png', dpi=300, bbox_inches='tight')
    plt.close()

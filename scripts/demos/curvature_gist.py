...
def run_analysis(max_n=50, v_param=1.0, n_bootstrap=1000, output_csv=True):
    ...
    output_path = REFERENCE_DATA_DIR / 'kappas.csv'
    ...
    results = {
        ...
        'v_parameter': v_param,
        'output_filename': str(output_path.relative_to(ROOT)) if output_csv else None
    }
...
if __name__ == "__main__":
    ...
    print(f"  ✓ Artifacts saved: data/reference/kappas.csv")
